...
2020 & \href{https://cheps.sdsu.edu/docs/CHEPS_Working_Paper_No_2020401_FSMD_April_10_2020.pdf}{``Shelter-in-Place Orders and Public Health: Evidence from California During the COVID-19 Pandemic''}  \small (with with Andrew Friedson, Joseph Sabia, and Dhaval Dave), \\
...
\begin{itemize}[label={},itemindent=-2em,leftmargin=2em]
  ...
  \item \href{https://cheps.sdsu.edu/docs/More_Sports_Less_Crime_September_2020.pdf}{``More Sports, Less Crime: Title IX Reduced Female Arrests''} (with Joseph Sabia and Gokhan Kumpas\footnote[1]{student co-author})
...
% \vspace*{-.7cm}
% \begin{itemize}[label={},itemindent=-2em,leftmargin=2em]
%  \item ``More Sports, Less Crime? New Evidence from Title IX'' (with Joseph Sabia and Gokhan Kumpas) \\ \\
% \item``Do Tobacco 21 Laws Work?'' (with Calvin Bryan, Benjamin Hansen, and Joseph Sabia ) \\
% % 2020 & ``Industry Contours of Post-ACA Changes in Insurance Coverage'' (with Jeffery Clemens and Joseph Sabia ) \\
% % 2020 & ``Minimum Wages'' (with Jeffery Clemens and Joseph Sabia ) \\\item
% \end{itemize}
% \vspace*{-1cm}
